function [TX,RX] = presetTXparams_B2B_QAM_SC(SIG,FEC_rate,PILOTS)

% Last Update: 29/03/2019


%% Input Parser
if ~exist('FEC_rate','var')
    FEC_rate = 1;
end
if exist('PILOTS','var') && PILOTS.active
...
Rs_gross = SIG.symRate_net / FEC_rate / pilotRate;
...
TX.SIG.bitRate_net = TX.SIG.bitRate * FEC_rate * pilotRate;
